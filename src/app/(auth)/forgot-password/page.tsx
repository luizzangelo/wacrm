...
import { AUTH_EMAIL_SELF_SERVICE_ENABLED } from '@/lib/auth/policy';
...
// Retained for a future, explicitly approved SMTP rollout. This component is
// never mounted while recovery is support-only, so no Auth request is issued.
